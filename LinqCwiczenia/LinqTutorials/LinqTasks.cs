...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Dept> result = Depts.GetDeptsWithPredeterminedNumberOfEmployees(Emps);
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.GetJobNamesAndEmployeeCountForJobsContainingTheLetterA();
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> GetEmpsWithSubordinates(this IEnumerable<Emp> emps)
        {
            var result = emps
                ...
                .OrderBy(e => e.Ename.Split(' ')[1])
                .ThenByDescending(e => e.Salary);
            return result;
        }

        public static IEnumerable<Dept> GetDeptsWithPredeterminedNumberOfEmployees(this IEnumerable<Dept> depts,
            IEnumerable<Emp> emps)
        {
            var result = depts
                ...
                .Where(join => !join.Employees.Any() || join.Employees.Count() == 5)
                .OrderBy(join => join.Department.Dname)
                .Select(join => join.Department);
            return result;
        }

        public static IEnumerable<object> GetJobNamesAndEmployeeCountForJobsContainingTheLetterA(this IEnumerable<Emp> emps)
        {
            var result = emps
